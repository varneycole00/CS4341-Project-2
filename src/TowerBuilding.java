...
public class TowerBuilding extends Puzzle implements Cloneable{
    private ArrayList<Piece> pieces; //All pieces from .txt file
    ...
    public float getScore(){
        if(tower.get(0).getType()!=Type.DOOR || tower.get(tower.size()-1).getType()!=Type.LOOKOUT) //Rule 1 and 2
            return 0;
        ...
        for(int i = tower.size()-2; i >=0 ; i--){
            ...
            if(i!=0 && tower.get(i).getType()!=Type.WALL) //Rule 3
                return 0;
